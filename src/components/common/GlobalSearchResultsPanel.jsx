const GlobalSearchResultsPanel = ({
  ...
  return (
    <div className="max-h-[70vh] max-w-full overflow-x-hidden overflow-y-auto rounded-xl border border-slate-200 bg-white p-2 shadow-[0_18px_34px_-22px_rgba(15,23,42,0.5)] xl:max-h-[360px]">
